...
class Settings:
    ...
    DEFAULT_PROMPT: str = (
        "Analyze the objects in these images from the security camera. "
        "Focus on the actions, behavior, and potential intent of the objects, "
        "rather than just describing its appearance."
    )
